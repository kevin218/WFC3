...
class event_init(object):
    def __init__(self):
        ...
        self.eventdir   = '2017-07-09-w1'   # Directory name; defined by user; date is defined by user
        ...
        # self.sep_back   = 30                # ?
        self.spec_width = 20                # Half-width of spectral extraction region (in the cross-dispersion); was 17
        self.fitbghw    = 20                # Distance from the spectrum (in the cross-dispersion) to start background subtraction; was 17
        ...
        self.objfile   = 'all'              # Look at all files in the director; options: 'all' or 'filename.txt'; objectList.txt for specific files
